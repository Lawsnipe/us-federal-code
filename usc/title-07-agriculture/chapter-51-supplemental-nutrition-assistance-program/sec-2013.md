...
#### (A) Definition of payment error rate

In this paragraph, the term "payment error rate" has the meaning given the term in section 2025(c)(2) of this title.
...
For fiscal year 2028, to calculate the applicable State share under clause (i), a State may elect to use the payment error rate of the State from fiscal year 2025 or 2026.
...
If, for fiscal year 2026, the payment error rate of a State multiplied by 1.5 is equal to or above 20 percent, the implementation date under clause (i) for that State shall be fiscal year 2030.

#### (3) Maximum Federal payment
