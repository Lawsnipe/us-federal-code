...
Effective beginning with the 2025 crop year, subject to subparagraphs (B) and (C), the term "reference price", with respect to a covered commodity for a crop year, means the following:
...
Effective beginning with the 2031 crop year, the reference prices defined in subparagraph (A) with respect to a covered commodity shall equal the reference price in the previous crop year multiplied by 1.005.

#### (C) Limitation

In no case shall a reference price for a covered commodity exceed 113 percent of the reference price for such covered commodity listed in subparagraph (A).
