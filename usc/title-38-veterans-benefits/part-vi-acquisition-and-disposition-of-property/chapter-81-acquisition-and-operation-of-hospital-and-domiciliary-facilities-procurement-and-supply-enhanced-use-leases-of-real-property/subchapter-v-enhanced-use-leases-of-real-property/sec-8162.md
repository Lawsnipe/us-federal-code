...
(2) The Secretary may enter into an enhanced-use lease only for the provision of supportive housing and the [1](#8162_1_target) lease is not inconsistent with and will not adversely affect the mission of the Department.
...
[1 So in original. Probably should be preceded by "only if".](#8162_1)