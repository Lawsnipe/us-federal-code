...
(c) [1](#8175_1_target) Projected Funding Needs.—(1) In addition to the matters included under subsections (a) and (b), the Secretary shall ensure that the budget justification materials described in subsection (a) also include a projection of the one-year, two-year, and three-year funding needs of the Department for information technology, disaggregated by—
...
[1 See Effective Date of Subsection (c) note below.](#8175_1)