...
(3) If, based upon an evaluation under paragraph (1)(A), the Under Secretary for Health determines that there is a deviation referred to in that paragraph, the Under Secretary for Health shall explain the deviation in the report submitted under subsection (f).[1](#7311_1_target)
...
(d) Based on the information compiled and the comparisons, analyses, evaluations, and explanations made under subsections (b) and (c), the Under Secretary for Health, in the report under subsection (f),[1](#7311_1_target) shall make such recommendations with respect to quality assurance as the Under Secretary for Health considers appropriate.
...
[1 See References in Text note below.](#7311_1)