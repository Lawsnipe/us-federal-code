...
(c) Penalty.—(1) An employee who does not complete a period of obligated service under this section shall owe the Federal Government an amount determined in accordance with the following formula: *A = B  ×  ((T - S) ÷* T)).[1](#7696_1_target)
...
[1 So in original. There is an extra closing parenthesis in the formula.](#7696_1)