...
(ii) Subject to clauses (iii) and (iv), a monthly stipend in an amount equal to $83 for each month (or pro rata amount for each partial month) of training pursued for books [1](#3313_1_target) supplies, equipment, and other educational costs.
...
[1 So in original. Probably should be followed by a comma.](#3313_1)