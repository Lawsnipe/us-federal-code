...
(iv) the primary risk parameters associated with the current procurement cost for the program (as that term is used in section 4355(4) [1](#4351_1_target) of this title);
...
[1 See References in Text note below.](#4351_1)