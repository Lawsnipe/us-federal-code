...
(ii) The submission of prices paid under clause (i) by an offereor [1](#3702_1_target) with respect to a subcontract shall be deemed to be the submission of cost or pricing data by such offeror with respect to such subcontract as required by subparagraph (A) if a contracting officer of the Department of Defense determines that the prices submitted under such clause are fair and reasonable based on supported cost or pricing data within the last 12 months.
...
[1 So in original. Probably should be "offeror".](#3702_1)