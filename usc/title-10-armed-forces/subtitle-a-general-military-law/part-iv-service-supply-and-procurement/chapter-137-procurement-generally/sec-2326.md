...
(e) Allowable Profit.—(1) The head of an agency shall ensure that the profit allowed on an undefinitized contractual action for which the final price is negotiated after a substantial portion of the performance required is completed reflects—
...
Subsecs. (f) to (i). Pub. L. 114–328, §811(2), (3), added subsec. (f) and (g) and redesignated former subsecs. (f) and (g) as (h) and (i), respectively.
