...
(c) Unfunded Priority Defined.—In this section, the term "unfunded priority", with respect to a fiscal year, means an activity related to an audit readiness or remediation effort stemming from a relevant requirement under the Chief Financial Officer Act [1](#240i_1_target) (Public Law 101–576), chapter 9 of title 31, or this chapter that—
...
[1 See References in Text note below.](#240i_1)