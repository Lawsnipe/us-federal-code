...
(4) Except as otherwise directed by the Secretary of Defense, all forces assigned to a unified combatant command shall be under the command of,[1](#162_1_target) the commander of that command. The preceding sentence applies to forces assigned to a specified combatant command only as prescribed by the Secretary of Defense.
...
[1 So in original. The comma probably should not appear.](#162_1)