...
(e) Readiness of National Guard to Perform Civil Support Missions.—(1) Each report shall also include an assessment of the readiness of the National Guard to perform tasks required to support the National Response Framework for support to civil authorities.
...
(h) Combat Support and Related Agencies Assessment.—(1) Each report shall also include an assessment by the Secretary of Defense of the military readiness of the combat support and related agencies, including, for each such agency—
...
(i) Major Exercise Assessments.—(1) Each report under this section shall also include information on each major exercise conducted by a geographic or functional combatant command or military department, including—
