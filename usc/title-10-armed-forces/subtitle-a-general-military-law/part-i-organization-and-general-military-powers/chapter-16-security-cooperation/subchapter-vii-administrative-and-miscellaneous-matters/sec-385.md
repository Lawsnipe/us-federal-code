...
(B) a detailed description of the security cooperation objectives of the Department, include [1](#385_1_target) the theater campaign plan of the combatant command concerned, that will be advanced;
...
[1 So in original. Probably should be "including".](#385_1)