...
(b) an evaluation of each parcel proposed for addition or deletion to the unit based on the analysis under paragraph (1); [1](#1a-12_1_target)

(c) an assessment of the impact of potential boundary adjustments taking into consideration the factors in paragraph (c) [2](#1a-12_2_target) as well as the effect of the adjustments on the local communities and surrounding area.
