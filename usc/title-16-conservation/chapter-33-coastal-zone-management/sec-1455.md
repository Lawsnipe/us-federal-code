...
(A) to administer land use and water use regulations to control development [1](#1455_1_target) to ensure compliance with the management program, and to resolve conflicts among competing uses; and
...
[1 So in original. Probably should be followed by a comma.](#1455_1)