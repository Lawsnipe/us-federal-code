...
(B) any study for a project, which project is authorized for construction by this Act and is not subject to section 903(b); [1](#2282_1_target)
...
(B) make publicly available, including on the Internet, a copy of the annual report described in subparagraph (A) not later than 14 days after date [2](#2282_2_target) on which a report is submitted to Congress.
...
[1 See References in Text note below.](#2282_1)

[2 So in original. Probably should be preceded by "the".](#2282_2)