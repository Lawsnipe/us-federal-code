...
Subject to subsection (h), the Administrator shall use the amounts appropriated to carry out this section for fiscal year 2002 for making grants to municipalities and municipal entities under subsection (a)(2), in accordance with the criteria set forth in subsection (b).

#### (2) Fiscal year 2003

Subject to subsection (h), the Administrator shall use the amounts appropriated to carry out this section for fiscal year 2003 as follows:
