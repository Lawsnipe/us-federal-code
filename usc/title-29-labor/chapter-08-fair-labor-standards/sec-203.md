...
(vi) the [1](#203_1_target) Government Publishing Office;
...
**2018**—Subsec. (m). Pub. L. 115–141 designated existing provisions as par. (1), redesignated former pars. (1) and (2) as cls. (i) and (ii), respectively, inserted "(2)(A)" before "In determining the wage", substituted "clause (i)" for "paragraph (1)" in cl. (ii) of par. (2)(A), and added subpar. (B) at end.
...
[1 So in original. Probably should be preceded by "in".](#203_1)

[2 See References in Text note below.](#203_2)