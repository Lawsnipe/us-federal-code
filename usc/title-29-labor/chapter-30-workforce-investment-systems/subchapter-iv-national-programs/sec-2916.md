...
To be eligible to receive a grant under clause (i), an entity shall be a nonprofit partnership that—
...
A State shall use amounts awarded under a grant under this subparagraph to provide funding to the State agency that administers the Wagner-Peyser Act \[29 U.S.C. 49 et seq.\] and State unemployment compensation programs to carry out the following activities using State agency merit staff:
...
Under the program established under paragraph (1), the Secretary shall award competitive grants of sufficient size to eligible entities to enable such entities to carry out training that leads to economic self-sufficiency. The Secretary shall give priority to entities that serve individuals in families with income of less than 200 percent of the sufficiency standard for the local areas where the training is conducted that specifies, as defined by the State, or where such standard is not established, the income needs of families, by family size, the number and ages of children in the family, and sub-State geographical considerations. Grants shall be awarded to ensure geographic diversity.
...
[1 So in original. Probably should be paragraph "(6)".](#2916_1)