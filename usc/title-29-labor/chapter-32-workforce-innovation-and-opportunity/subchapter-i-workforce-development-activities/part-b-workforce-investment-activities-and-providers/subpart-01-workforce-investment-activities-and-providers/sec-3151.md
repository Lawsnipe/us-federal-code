...
For local areas in a State that are not covered by paragraph (1)(A)(i)(I), an entity administering a program funded with direct spending as defined in section 900(c)(8) of title 2, as in effect on February 15, 2014 [1](#3151_1_target) shall not be required to provide, for purposes of this paragraph, an amount in excess of the amount determined under subparagraph (C)(i) to be equivalent to the cost of the proportionate use of the one-stop centers for the one-stop partner for such program in the State.
...
[1 So in original. Probably should be "2014,".](#3151_1)