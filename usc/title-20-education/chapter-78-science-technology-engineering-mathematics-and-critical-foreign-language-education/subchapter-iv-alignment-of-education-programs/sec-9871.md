...
(3) enable [1](#9871_1_target) States to have valid and reliable information to inform education policy and practice.
...
(B) A description of how the concerns and interests of the larger education community, including parents, students, teachers, teacher educators, principals, and preschool administrators [2](#9871_2_target) will be represented in carrying out the authorized activities described in subsection (e).
...
[1 So in original. Probably should be "to enable".](#9871_1)

[2 So in original. Probably should be followed by a comma.](#9871_2)