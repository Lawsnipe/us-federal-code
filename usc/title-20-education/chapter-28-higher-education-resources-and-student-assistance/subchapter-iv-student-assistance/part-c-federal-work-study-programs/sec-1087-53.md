...
(D) will not pay any wage to students employed under this subpart [1](#1087-53_1_target) that is less than the current Federal minimum wage as mandated by section 206 of title 29;
...
As part of its agreement agreement [2](#1087-53_2_target) described in subsection (b) of this section, an institution of higher education may, at its option, enter into an additional agreement with the Secretary which shall—
...
[1 So in original. Probably should be "part".](#1087-53_1)

[2 So in original.](#1087-53_2)