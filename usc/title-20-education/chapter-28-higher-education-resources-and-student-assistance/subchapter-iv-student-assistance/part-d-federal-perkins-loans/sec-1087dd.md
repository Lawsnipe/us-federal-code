...
(G) shall provide that no note or evidence of obligation may be assigned by the lender, except upon the transfer of the borrower to another institution participating under this part (or, if not so participating, is eligible to do so and is approved by the Secretary for such purpose), to such institution, and except as necessary to carry out section 1087cc(a)(6) [1](#1087dd_1_target) of this title;
...
[1 See References in Text note below.](#1087dd_1)