...
(iv) in which the borrower is receiving treatment for cancer and the 6 months after such period.[1](#1077_1_target)
...
(G)(i) contains a notice of the system,[2](#1077_2_target) of disclosure of information concerning such loan to consumer reporting agencies under section 1080a of this title, and (ii) provides that the lender on request of the borrower will provide information on the repayment status of the note to such consumer reporting agencies;
...
[1 So in original. The period probably should be a semicolon.](#1077_1)

[2 So in original. The comma probably should not appear.](#1077_2)