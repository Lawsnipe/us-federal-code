...
A conservator shall have all the powers of the shareholders, directors, and officers of the bank and may operate the bank in its own name unless the Comptroller [1](#206_1_target) in the order of appointment limits the conservator's authority.
...
[1 So in original. Probably should be "Comptroller of the Currency".](#206_1)