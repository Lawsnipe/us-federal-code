...
(5) Membership of the Advisory Board shall not include any person who, during the previous 24-month period, was required to register with the Secretary under section 3537b(c) [1](#1708_1_target) of title 42 or employed a person for purposes that required such person to so register.
...
The Board may issue a letter of reprimand only once to a mortgagee without taking action under subparagraphs [2](#1708_2_target) (B), (C), or (D) of this section. A letter of reprimand shall explain the violation and describe actions the mortgagee should take to correct the violation.
...
(E) convicted of, or who has pled guilty or nolo contendre [3](#1708_3_target) to, a felony related to participation in the real estate or mortgage loan industry—
...
(2) Within 60 days of receipt of a notification of action that could lead to withdrawal under subsection [4](#1708_4_target) (1), the Federal Housing Administration or the Government National Mortgage Association shall—
...
(B) that each appraisal be a written statement used in connection with a real estate transaction that is independently an [5](#1708_5_target) impartially prepared by a licensed or certified appraiser setting forth an opinion of defined value of an adequately described property as of a specific date, supported by presentation and analysis of relevant market information.
...
[1 See References in Text note below.](#1708_1)

[2 So in original. Probably should be "subparagraph".](#1708_2)

[3 So in original. Probably should be "contendere".](#1708_3)

[4 So in original. Probably should be "paragraph".](#1708_4)

[5 So in original. Probably should be "and".](#1708_5)