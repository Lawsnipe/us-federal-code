...
(2) to allow homeowners to avoid foreclosure by reducing the principle [1](#1715z-23_1_target) balance outstanding, and interest rate charged, on their mortgages;
...
(D) be wholly consistent with the appraisal standards, practices, and procedures under section 1708(e) [2](#1715z-23_2_target) of this title that apply to all loans insured under this chapter; and
...
(3) The average amount by which the principle [1](#1715z-23_1_target) balance outstanding on mortgages insured this section was reduced.
...
[1 So in original. Probably should be "principal".](#1715z-23_1)

[2 See References in Text note below.](#1715z-23_2)