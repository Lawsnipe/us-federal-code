...
If a State is approved for participation under paragraph (1), each financial institution with a participation agreement in effect with the participating State shall immediately be considered a participating financial institution. Reimbursements may be made under section 4747 [1](#4743_1_target) of this title in connection with all contributions made to the reserve fund by the State in connection with lending that occurs on or after the date on which the Fund approves the State for participation.
...
A State that is approved for participation in accordance with this subsection may continue to implement the program [2](#4743_2_target) utilizing the reserve funds accumulated under the State program.
...
[1 See References in Text note below.](#4743_1)

[2 So in original. Probably should be capitalized.](#4743_2)