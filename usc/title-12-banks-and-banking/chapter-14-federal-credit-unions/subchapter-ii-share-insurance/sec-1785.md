...
This subparagraph shall not apply to an offense described under paragraph (1)(B).[1](#1785_1_target)
...
(I) cases involving an offense described under paragraph (1)(B); [1](#1785_1_target) and
...
The term "consent application" means an application filed with Board [2](#1785_2_target) by an individual (or by an insured credit union on behalf of an individual) seeking the written consent of the Board under paragraph (1)(A).
...
[2 So in original. Probably should be preceded by "the".](#1785_2)