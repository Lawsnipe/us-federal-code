...
(viii) any reserve described in clause [1](#5903_1_target) (i) through (iii) or clause [1](#5903_1_target) (vi) through (vii) in tokenized form, provided that such reserves comply with all applicable laws and regulations;
...
A permitted payment stablecoin issuer shall, each month, have the information disclosed in the previous month-end report required under paragraph (1)(D) [2](#5903_2_target) examined by a registered public accounting firm.
...
(cc) shared with non-affiliates; except [1](#5903_1_target)
...
With respect to any recertification certification [1](#5903_1_target) submitted by a State payment stablecoin regulator under paragraph (4), the Stablecoin Certification Review Committee shall only deny the recertification if—
...
[1 So in original.](#5903_1)

[2 So in original. Probably should be "paragraph (1)(C)".](#5903_2)

[3 See References in Text note below.](#5903_3)