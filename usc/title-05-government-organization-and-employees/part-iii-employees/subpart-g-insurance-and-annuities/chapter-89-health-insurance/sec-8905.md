...
Pub. L. 113–67, div. A, title VII, §706(d), Dec. 26, 2013, 127 Stat. 1194, provided that: “For the first contract year for which an employee may enroll for self plus one coverage under chapter 89 of title 5, United States Code \[5 U.S.C. 8901 et seq.\], the Office of Personnel Management shall determine the weighted average of the subscription charges that will be in effect for the contract year for enrollments for self plus one under such chapter based on an actuarial analysis.”
