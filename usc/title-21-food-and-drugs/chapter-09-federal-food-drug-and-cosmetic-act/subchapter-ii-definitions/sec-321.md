...
(w) The term "animal feed", as used in paragraph (w) [2](#321_2_target) of this section, in section 360b of this title, and in provisions of this chapter referring to such paragraph or section, means an article which is intended for use for food for animals other than man and which is intended for use as a substantial source of nutrients in the diet of the animal, and is not limited to a mixture intended to be the sole ration of the animal.
...
which was not before such approval, certification, licensing, or authorization marketed as a dietary supplement or as a food unless the Secretary, in the Secretary's discretion, has issued a regulation, after notice and comment, finding that the article would be lawful under this chapter.[3](#321_3_target)
...
[1 So in original. Probably should be "Pharmacopeia,".](#321_1)

[2 So in original. Probably should be paragraph "(v)".](#321_2)

[3 So in original. Provision probably should be set flush with subpar. (B).](#321_3)