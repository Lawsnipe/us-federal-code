...
(5) the date each new infant formula described in subparagraph (A) [1](#350a-1_1_target) was first marketed, if available.
...
[1 So in original. There is no subparagraph (A).](#350a-1_1)