...
(ii) if the Secretary has an operating reserve in excess of the number of weeks specified in subparagraph (C) for that fiscal year, the Secretary shall [1](#379j-12_1_target) decrease the fee revenue amount to provide not more than the number of weeks specified in subparagraph (C) for that fiscal year.
...
[1 So in original. The words "the Secretary shall" also appear at end of introductory provisions.](#379j-12_1)