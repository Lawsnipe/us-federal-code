...
(C) the number of resubmitted original biosimilar biological product applications filed per fiscal year and the number of approvals [1](#379j-53_1_target) letters issued by the agency for such applications.
...
(B) with respect to performance enhancement goals that were not achieved, a description of efforts the Food and Drug Administration has put in place for the fiscal year in which the report is submitted to improve the ability of such agency to meet each such goal for the such [1](#379j-53_1_target) fiscal year.
