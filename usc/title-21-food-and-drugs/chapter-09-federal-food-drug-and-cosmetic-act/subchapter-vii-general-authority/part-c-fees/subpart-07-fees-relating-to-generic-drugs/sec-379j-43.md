...
(B) with respect to performance enhancement goals that were not achieved, a detailed description of efforts the Food and Drug Administration has put in place for the fiscal year in which the report is submitted to improve the ability of such agency to meet each such goal for the such [1](#379j-43_1_target) fiscal year.
