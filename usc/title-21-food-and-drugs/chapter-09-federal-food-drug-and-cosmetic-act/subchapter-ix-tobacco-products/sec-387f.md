...
(1) the manner in which interested persons may examine data and other information on which the notice or findings is [1](#387f_1_target) based; and
...
[1 So in original. Probably should be "are".](#387f_1)