...
Changes made to package labels solely to incorporate the product identifier may be submitted to the Secretary in the annual report of an establishment, in accordance with section 314.70(d) of chapter [1](#360eee-1_1_target) 21, Code of Federal Regulations (or any successor regulation).
...
(i) prior to, or at the time of, each transaction in which such manufacturer transfers ownership of a product, provide the subsequent owner with transaction history, transaction information, and a transaction statement, in a single document in an [2](#360eee-1_2_target) paper or electronic format; and
...
[2 So in original. Probably should be "a".](#360eee-1_2)