...
(i) the burden of creating a single, shared system outweighs the benefit of a single, system,[1](#355-1_1_target) taking into consideration the impact on health care providers, patients, the applicant for the abbreviated new drug application, and the holder of the reference drug product; or
...
[1 So in original. Probably should be "single, shared system,".](#355-1_1)