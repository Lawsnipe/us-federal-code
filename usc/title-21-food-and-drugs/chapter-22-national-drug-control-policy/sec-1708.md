...
#### (a) Emerging Threats Coordinator [1](#1708_1_target)
...
(F) any other information necessary to inform the public of the status, progress, or response of [2](#1708_2_target) an emerging drug threat.
...
(iii) monitor implementation of the plan by coordinating the development and implementation of collection and reporting systems to support performance measurement and adherence to the plan by agencies identified in [3](#1708_3_target) plan, where appropriate.
...
The Director shall, to the extent feasible and appropriate, conduct a national anti-drug media campaign (referred to in this chapter [4](#1708_4_target) as the "national media campaign") in accordance with this subsection for the purposes of—
...
[1 So in original. Probably should be "Emerging and Continuing Threats Coordinator".](#1708_1)

[2 So in original.](#1708_2)

[3 So in original. The word "the" probably should appear.](#1708_3)

[4 See References in Text note below.](#1708_4)