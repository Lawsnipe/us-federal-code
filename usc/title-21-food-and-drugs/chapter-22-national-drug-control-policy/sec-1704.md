...
(i) all drug control grants and pertinent identifying information for each grant; [2](#1704_2_target)
...
(C) identify barriers in the grant application process impediments that applicants currently have in the grant application process [3](#1704_3_target) with applicable agencies.

#### (2) National Drug Control [4](#1704_4_target) Agencies
...
[1 So in original. Probably should be "than".](#1704_1)

[2 So in original. Probably should be followed by "and".](#1704_2)

[3 So in original.](#1704_3)

[4 So in original. Probably should be followed by "Program".](#1704_4)