...
(H) allow any person subject to this subsection to maintain records required under this subsection at a central or reasonably accessible location provided that such records can be made available to the Secretary not later than 24 hours after the Secretary requests such records; and [1](#2223_1_target)
...
(II) the term "commingled raw agricultural commodity" shall not include types of fruits and vegetables that are raw agricultural commodities for which the Secretary has determined that standards promulgated under section 350h of this title (as added by section 105) [2](#2223_2_target) would minimize the risk of serious adverse health consequences or death; and
...
(C) was adulterated as described in subparagraph (A) on a particular farm (as defined in section 1.227 of chapter [3](#2223_3_target) 21, Code of Federal Regulations (or any successor regulation)).
...
[1 So in original. The word "and" probably should not appear.](#2223_1)

[2 See References in Text note below.](#2223_2)

[3 So in original. Probably should be "title".](#2223_3)