...
(2) to the extent not used under paragraph (1) [1](#32903_1_target) any of the 5 consecutive model years immediately after the model year for which the credits are earned.
...
[1 So in original. Probably should be followed by a comma.](#32903_1)