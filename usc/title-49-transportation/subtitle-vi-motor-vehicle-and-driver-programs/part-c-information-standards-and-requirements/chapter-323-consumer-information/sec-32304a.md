...
(D) a national tire maintenance consumer education program including,[1](#32304A_1_target) information on tire inflation pressure, alignment, rotation, and tread wear to maximize fuel efficiency, safety, and durability of replacement tires.
...
(C) Benchmarking.—The Secretary shall conduct testing to benchmark the wet traction performance of tire models available for sale in the United States as of the date of enactment of this Act [2](#32304A_2_target) to ensure that the minimum performance standards promulgated under paragraph (1) are tailored to—
...
(A) the regulations under subsections (b) and (c) not later than 24 months after the date of enactment of this Act; [2](#32304A_2_target) and
...
[1 So in original. Probably should be ", including".](#32304A_1)

[2 See References in Text note below.](#32304A_2)