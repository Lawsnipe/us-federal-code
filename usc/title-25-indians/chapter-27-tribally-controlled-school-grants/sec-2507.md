...
(11) Section 108(c) \[25 U.S.C. 5329(c)\] (Model Agreements provisions (1)(a)(5) [1](#2507_1_target) (relating to limitations of costs), (1)(a)(7) [2](#2507_2_target) (relating to records and monitoring), (1)(a)(8) [3](#2507_3_target) (relating to property), and (a)(1)(9) [4](#2507_4_target) (relating to availability of funds).[5](#2507_5_target)
...
In any case in which the first day of July immediately following the date of an election under paragraph (1) is less than 60 days after such election, such election shall not take effect until the first day of July of [6](#2507_6_target) year following the year in which the election is made.
...
Any tribe or tribal organization which assumes operation of a Bureau school with assistance under this chapter and any tribe or tribal organization which elects to operate a school with assistance under this chapter rather that [7](#2507_7_target) to continue as a contract school shall be entitled to any funds which would carryover from the previous fiscal year as if such school were operated as a contract school.
...
[1 So in original. Probably should be "1(b)(5)".](#2507_1)

[2 So in original. Probably should be "1(b)(7)".](#2507_2)

[3 So in original. Probably should be "1(b)(8)".](#2507_3)

[4 So in original. Probably should be "1(b)(9)".](#2507_4)

[5 So in original. There probably should be a second closing parenthesis.](#2507_5)

[6 So in original. Probably should be followed by "the".](#2507_6)

[7 So in original. Probably should be "than".](#2507_7)