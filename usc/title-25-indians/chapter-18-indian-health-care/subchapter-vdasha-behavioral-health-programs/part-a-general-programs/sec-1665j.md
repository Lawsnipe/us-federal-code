...
For purposes of this subsection,[1](#1665j_1_target) the Secretary shall, in evaluating project applications or proposals, use the same criteria that the Secretary uses in evaluating any other application or proposal for such funding.
...
[1 So in original. Probably should be "section,".](#1665j_1)