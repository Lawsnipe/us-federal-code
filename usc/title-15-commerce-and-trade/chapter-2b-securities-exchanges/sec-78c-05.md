...
A broker, dealer, or security-based swap dealer shall treat and deal with all money, securities, and property of any security-based swaps customer received to margin, guarantee, or secure a security-based swap cleared by or though [1](#78c-5_1_target) a clearing agency (including money, securities, or property accruing to the security-based swaps customer as the result of such a security-based swap) as belonging to the security-based swaps customer.
...
[1 So in original. Probably should be “through”.](#78c-5_1)

[2 So in original.](#78c-5_2)