...
Subsec. (d)(3)(A). Pub. L. 114–182, §6(5)(C)(i)(I), substituted in introductory provisions ", and compliance with the proposed requirements to be mandatory, upon publication in the Federal Register of the proposed rule and until the compliance dates applicable to such requirements in a final rule promulgated under section 2605(a) of this title or until the Administrator revokes such proposed rule, in accordance with subparagraph (B), if" for "upon its publication in the Federal Register and until the effective date of final action taken, in accordance with subparagraph (B), respecting such rule if".
