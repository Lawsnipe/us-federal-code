...
(B) the rate determined by any method prescribed by the Bureau as a method which materially simplifies computation while retaining reasonable accuracy as compared with the rate determined under subparagraph (A).[1](#1606_1_target)
