...
(1) [1](#1693b_1_target) consult with the other agencies referred to in section 1693o [2](#1693b_2_target) of this title and take into account, and allow for, the continuing evolution of electronic banking services and the technology utilized in such services,
...
(3) [1](#1693b_1_target) to the extent practicable, the Board shall demonstrate that the consumer protections of the proposed regulations outweigh the compliance costs imposed upon consumers and financial institutions, and

(4) [1](#1693b_1_target) any proposed regulations and accompanying analyses shall be sent promptly to Congress by the Board.
...
(i) affects or alters the protections otherwise applicable with respect to benefits established by any other provision [3](#1693b_3_target) Federal, State, or local law; or
...
[1 So in original. See 2010 Amendment note below.](#1693b_1)

[2 See References in Text note below.](#1693b_2)

[3 So in original. Probably should be followed by "of".](#1693b_3)