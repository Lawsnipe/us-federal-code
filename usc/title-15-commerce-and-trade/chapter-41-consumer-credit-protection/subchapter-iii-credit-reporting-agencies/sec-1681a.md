...
(D) a communication described in subsection (o) or (x) [1](#1681a_1_target) of this section.
...
(C) the payment for the provision of health care to an individual.[2](#1681a_2_target)
...
(5) New credit plan.—The term “new credit plan” means a new account under an open end credit plan (as defined in section 1602(i) [1](#1681a_1_target) of this title) or a new credit transaction not under an open end credit plan.
...
(v) Commission.—The term “Commission” means the Bureau.[3](#1681a_3_target)
...
[1 See References in Text note below.](#1681a_1)

[2 So in original. The period probably should be “; and”.](#1681a_2)

[3 So in original.](#1681a_3)