...
(D) the rights of the borrower to request a loan deferral from a lender, and guidance on how to do [1](#9011_1_target) successfully transition directly to a loan deferral once subsidy payments under this section are concluded.
...
[1 So in original. The word "do" probably should not appear.](#9011_1)