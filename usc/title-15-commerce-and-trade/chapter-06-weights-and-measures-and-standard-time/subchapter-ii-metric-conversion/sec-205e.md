...
(10) submit annually to the Congress and to the President a report on its activities. Each such report shall include a status report on the conversion process as well as projections for the conversion process. Such report may include recommendations covering any legislation or executive action needed to implement the the [1](#205e_1_target) programs of conversion accepted by the Board. The Board may also submit such other reports and recommendations as it deems necessary; and
