...
(2) a detailed account of the results of export growth activities of the Administration, including the activities of each district and regional office of the Administration, based on the performance measures described in subsection (i); [1](#649_1_target)
...
[1 So in original. Probably should be a reference to subsection (j).](#649_1)