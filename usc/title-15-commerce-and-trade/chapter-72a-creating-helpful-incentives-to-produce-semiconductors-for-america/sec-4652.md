...
(i) the covered entity has a documented interest in constructing, expanding, or modernizing a facility described in paragraph (1) [1](#4652_1_target)
...
(iii) aggregated workforce data, including data by race or ethnicity, sex, and job categories.[2](#4652_2_target)
...
The loan agreement for a loan guaranteed under this subsection shall provide that no provision of the loan agreement may be amended of [3](#4652_3_target) waived without the consent of the Secretary.
...
[1 So in original. Probably should be followed by a semicolon.](#4652_1)

[2 So in original. The period probably should be "; and".](#4652_2)

[3 So in original. Probably should be "or".](#4652_3)