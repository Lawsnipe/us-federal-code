...
In developing and implementing the plan under paragraph (1), the Administrator may make such accommodations as the Administrator considers appropriate to ensure that the public release of any model, information, documentation, or data pursuant to the plan do [1](#8512a_1_target) not jeopardize—
...
In carrying out paragraphs (1) and (2), the Administrator may use government servers, contracts or agreements with a private vendor, or any other platform consistent with the purpose of this title.[2](#8512a_2_target)
...
[1 So in original. Probably should be "does".](#8512a_1)

[2 See References in Text note below.](#8512a_2)