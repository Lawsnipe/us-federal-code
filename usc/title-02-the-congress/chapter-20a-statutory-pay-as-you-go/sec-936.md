...
(K) The phaseout of personal exemptions and the overall limitation on itemized deductions as in effect for tax year 2010, as provided for under sections 102 and 103 of EGTRRA of 2001, respectively, and any later amendment through December 31, 2009, affecting taxpayer [1](#936_1_target) with adjusted gross income of $200,000 or less for single filers and $250,000 for joint filers, with these income levels indexed for inflation in each subsequent year consistent with subsection (g).
...
(B) if more than 1 of the income tax provisions is [2](#936_2_target) included in a single piece of legislation, those provisions shall be estimated in the order in which they appear.
...
[1 So in original. Probably should be "taxpayers".](#936_1)

[2 So in original. Probably should be "are".](#936_2)