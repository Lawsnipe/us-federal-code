...
(i) budget authority that first becomes available for obligation in that year, including budget authority that becomes available in that year s [1](#622_1_target) a result of a reappropriation; or
...
(6) The term "deficit" means, with respect to a fiscal year, the amount by which outlays exceeds [2](#622_2_target) receipts during that year.

(7) The term "surplus" means, with respect to a fiscal year, the amount by which receipts exceeds [2](#622_2_target) outlays during that year.
...
[1 So in original. Probably should be "as".](#622_1)

[2 So in original. Probably should be "exceed".](#622_2)