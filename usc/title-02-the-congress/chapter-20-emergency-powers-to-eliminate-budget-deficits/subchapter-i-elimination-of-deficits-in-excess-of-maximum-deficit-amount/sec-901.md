...
(B) For the revised non-security [2](#901_2_target) category, the amount that is equal to the total budget authority for such category for base funding as published in the Congressional Budget Office cost estimate for the applicable appropriations Acts for the preceding fiscal year (table 1–S of H.R. 2617, published on December 21, 2022), reduced by one percent.
...
(A) for the revised security category, the amount calculated for such category in section [3](#901_3_target) (d)(1)(A); and

(B) for the revised non-security [2](#901_2_target) category, the amount calculated for each category in section [3](#901_3_target) (d)(1)(B).
...
[2 So in original.](#901_2)

[3 So in original. Probably should be "subsection".](#901_3)