...
(A) In general.—Subject to subparagraph (B), not earlier than 3 years after the date on which Copyright [1](#1510_1_target) Claims Board issues the first determination of the Copyright Claims Board, the Register of Copyrights may, in order to further the goals of the Copyright Claims Board, conduct a rulemaking to adjust the limits on monetary recovery or attorneys' fees and costs that may be awarded under this chapter.
...
[1 So in original. Probably should be preceded by "the".](#1510_1)