...
Whenever the requirements of subsections [1](#617_1_target) (a) or (b) are not achievable, a manufacturer or provider shall ensure that its equipment or service is compatible with existing peripheral devices or specialized customer premises equipment commonly used by individuals with disabilities to achieve access, unless the requirement of this subsection is not achievable.
...
(D) not mandate technical standards, except that the Commission may adopt technical standards as a safe harbor for such compliance if necessary to facilitate the manufacturers' and service providers' compliance with sections [2](#617_2_target) (a) through (c).
...
[1 So in original. Probably should be "subsection".](#617_1)

[2 So in original. Probably should be "subsections".](#617_2)