...
The Assistant Secretary may award a grant under the Program to any of the following entities if the entity is not serving, and has not served, as the administering entity for a State under section 1723(b) of this title:
...
(B) determines that the grant is no longer necessary to achieve the original purpose for which Assistant [1](#1724_1_target) Secretary awarded the grant; and
...
(Pub. L. 117–58, div. F, title III, §60305, Nov. 15, 2021, 135 Stat. 1222.)

[1 So in original. Probably should be preceded by "the".](#1724_1)