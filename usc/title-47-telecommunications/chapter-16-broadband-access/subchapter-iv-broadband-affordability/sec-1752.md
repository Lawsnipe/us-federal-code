...
The Commission shall adopt audit requirements to ensure that participating providers are in compliance with the requirements of this section and to prevent waste, fraud, and abuse in the Affordable Connectivity Program. A finding of waste, fraud, or abuse or an improper payment (as such term is defined in section 2(d) of the Improper Payments Information Act of 2002 (31 U.S.C. 3321 note)) [1](#1752_1_target) identified by the Commission or the Inspector General of the Commission shall include the following:
