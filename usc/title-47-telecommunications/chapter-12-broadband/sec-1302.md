...
As part of the inquiry required by subsection (b), the Commission shall compile a list of geographical areas that are not served by any provider of advanced telecommunications capability (as defined by subsection (d)(1)) [1](#1302_1_target) and to the extent that data from the Census Bureau is available, determine, for each such unserved area—
...
For purposes of this subsection: [2](#1302_2_target)
...
[1 See References in Text note below.](#1302_1)

[2 So in original. Probably should be "section:".](#1302_2)