...
(A) the authority of the Director of National Intelligence under this title,[1](#485_1_target) and the amendments made by this title,[1](#485_1_target) to set standards for information sharing throughout the intelligence community; and
...
(A) advise the President and the program manager in developing policies, procedures, guidelines, roles,[2](#485_2_target) and standards necessary to establish, implement, and maintain the ISE;
...
[1 See References in Text note below.](#485_1)

[2 So in original. Probably should be "rules,".](#485_2)