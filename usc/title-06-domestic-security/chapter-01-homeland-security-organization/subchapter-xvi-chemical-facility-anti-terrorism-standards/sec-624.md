...
(i) not later than 14 days after date [1](#624_1_target) on which the Secretary makes the determination, a written notification of noncompliance that includes a clear explanation of any deficiency in the security vulnerability assessment or site security plan; and
...
If a petition for review of an order is filed under subparagraph (B) and the review under that paragraph [2](#624_2_target) is not completed by the last day of the 30-day period beginning on the date on which the petition is filed, the order shall vacate automatically at the end of that period unless the Secretary determines, in writing, that the imminent threat providing a basis for the order continues to exist.
...
[1 So in original. Probably should be preceded by "the".](#624_1)

[2 So in original. Probably should be "that subparagraph".](#624_2)