...
(B) to [1](#1162_1_target) prepare, submit to the Secretary for approval, and implement a security plan in accordance with this section that addresses security performance requirements; and
...
[1 So in original. The word "to" probably should not appear.](#1162_1)