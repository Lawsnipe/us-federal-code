...
(3) Methods to analyze and address any matching performance errors related to race, gender, or age identified by the Administrator with respect to the use of biometric technology, including the deployment of facial recognition technology; [1](#1118_1_target)
...
(II) whether the use of biometric technologies and error rates in the use of such technologies disproportionately affect [2](#1118_2_target) a certain race, gender, or nationality; and
...
[1 So in original. The semicolon probably should be a period.](#1118_1)

[2 So in original. Probably should be "affects".](#1118_2)