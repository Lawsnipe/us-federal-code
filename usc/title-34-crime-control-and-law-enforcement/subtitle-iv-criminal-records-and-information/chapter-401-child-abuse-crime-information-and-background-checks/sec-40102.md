...
(ii) each covered individual described in subparagraph (B) will receive instructions on how to complete the appeals process if the covered individual wishes to challenge the accuracy or completeness of the information contained in the background report of the covered individual; and [1](#40102_1_target)

(iii) the appeals process is completed in a timely manner for each covered individual described in subparagraph (B); [2](#40102_2_target)
...
(3) that an authorized agency or designated entity, as applicable,,[3](#40102_3_target) upon receipt of a background check report lacking disposition data, shall conduct research in whatever State and local recordkeeping systems are available in order to obtain complete data;
...
[1 So in original. The word "and" probably should not appear.](#40102_1)

[2 So in original. Probably should be followed by "and".](#40102_2)

[3 So in original.](#40102_3)