...
(B) submit to Congress a report on the study conducted under subparagraph (A) that includes an assessment of whether the Bureau has provided the information required under subparagraph (B)(ix) [1](#10285_1_target) of paragraph (2) of this subsection in each report required under that paragraph.
...
[1 So in original. Probably means subpar. (I) of par. (2).](#10285_1)