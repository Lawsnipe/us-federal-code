...
(B) to an entity with which the Commandant has a cooperative agreement under section 4(e) [1](#504_1_target) of the Ports and Waterways Safety Act, and for which a term longer than 5 years is necessary to carry out the agreement.
