...
(1) In general.—The Commandant shall ensure that to the extent that the Commandant determines practicable, no cooperative agreement containing a clause described in subsection (c)(1),[1](#719_1_target) and no transaction entered into under subsection (a), provides for research that duplicates research being conducted under existing programs carried out by the Coast Guard.
...
[1 So in original. Probably should be "subsection (b)(1)".](#719_1)