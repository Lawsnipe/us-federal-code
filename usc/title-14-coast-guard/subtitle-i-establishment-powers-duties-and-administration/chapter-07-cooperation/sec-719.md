...
(2) Other agreements not feasible.—A cooperative agreement containing a clause described in subsection (c)(1),[1](#719_1_target) or under a transaction authorized by subsection (a), may be used for a research project only if the use of a standard contract, grant, or cooperative agreement for such project is not feasible or appropriate.
