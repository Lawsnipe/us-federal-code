...
(C) upon completion of the first Independent Data Submission, transmit a copy of such Submission to the affected community, provide the affected community a 30-day period during which the community may provide data to Administrator [1](#4101b_1_target) that can be used to supplement or modify the existing data, and incorporate any data that is consistent with prevailing engineering principles;
...
[1 So in original. Probably should be preceded by "the".](#4101b_1)

[2 So in original. The words "will be" probably should not appear.](#4101b_2)