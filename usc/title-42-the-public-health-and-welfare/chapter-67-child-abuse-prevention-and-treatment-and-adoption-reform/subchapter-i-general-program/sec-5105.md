...
(N) the information on the national incidence of child abuse and neglect specified in clauses (i) through (x) [1](#5105_1_target) of subparagraph (O); and
...
Not later than 1 years [3](#5105_3_target) after December 20, 2010, and every 2 years thereafter, the Secretary shall provide an opportunity for public comment concerning the priorities proposed under subparagraph (A) and maintain an official record of such public comment.

#### (4) [2](#5105_2_target) Study on shaken baby syndrome
...
[1 So in original. Probably should refer to clauses (i) through (xi).](#5105_1)

[2 So in original. There are two pars. designated "(4)".](#5105_2)

[3 So in original. Probably should be "year".](#5105_3)