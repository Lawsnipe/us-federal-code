...
(C) a description of the activities and results of the Program during the previous year, including an assessment of the effectiveness of the Program in furthering the goals established in the strategic plan under (3)(A) [1](#7704_1_target) ;
...
(ii) effectiveness of the Program in carrying out the activities under (a)(2) [3](#7704_3_target) of this section;
...
(G) support regional seismic networks, which shall complement the National Seismic Network; and [4](#7704_4_target)
...
[1 So in original. Probably should be preceded by "subparagraph".](#7704_1)
...
[4 So in original. The word "and" probably should not appear.](#7704_4)
