...
Each State in which all or part of a Serious Area is located shall, with respect to the Serious Area, make the submissions (other than those required under subsection (a)(1)(B) [1](#7512a_1_target)) applicable under subsection (a) to Moderate Areas with a design value of 12.7 ppm or greater at the time of classification, and shall also submit the revision and other items described under this subsection.
