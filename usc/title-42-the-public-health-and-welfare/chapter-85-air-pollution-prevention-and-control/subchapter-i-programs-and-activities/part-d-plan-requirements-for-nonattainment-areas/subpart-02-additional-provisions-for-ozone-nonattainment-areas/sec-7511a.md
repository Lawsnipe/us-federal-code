...
Each State in which all or part of an Extreme Area is located shall, with respect to the Extreme Area, make the submissions described under subsection (d) of this section (relating to Severe Areas), and shall also submit the revisions to the applicable implementation plan (including the plan items) described under this subsection. The provisions of clause (ii) of subsection (c)(2)(B) of this section (relating to reductions of less than 3 percent), the provisions of paragaphs [6](#7511a_6_target) (6), (7) and (8) of subsection (c) of this section (relating to de minimus [7](#7511a_7_target) rule and modification of sources), and the provisions of clause (ii) of subsection (b)(1)(A) of this section (relating to reductions of less than 15 percent) shall not apply in the case of an Extreme Area. For any Extreme Area, the terms “major source” and “major stationary source” includes [8](#7511a_8_target) (in addition to the sources described in section 7602 of this title) any stationary source or group of sources located within a contiguous area and under common control that emits, or has the potential to emit, at least 10 tons per year of volatile organic compounds.
