...
(B) In addition to the requirements of subparagraph (A), if the ozone design value for a Severe Area referred to in subparagraph (A) is above 0.140 ppm for the year of the applicable attainment date, or if the area has failed to achieve its most recent milestone under section 7511a(g) of this title, the new source review requirements applicable under this subpart in Extreme Areas shall apply in the area and the term [1](#7511_1_target) "major source" and "major stationary source" shall have the same meaning as in Extreme Areas.
...
[1 So in original. Probably should be "terms".](#7511_1)