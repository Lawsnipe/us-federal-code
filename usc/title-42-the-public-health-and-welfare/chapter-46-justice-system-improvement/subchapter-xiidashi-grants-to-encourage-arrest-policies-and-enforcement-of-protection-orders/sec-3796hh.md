...
(8) To develop or strengthen policies and training for police, prosecutors, and the judiciary in recognizing, investigating, and prosecuting instances of domestic violence [1](#3796hh_1_target) dating violence, sexual assault, and stalking against older individuals (as defined in section 3002 of this title) and individuals with disabilities (as defined in section 12102(2) of this title).
...
(1) States, Indian tribal governments [1](#3796hh_1_target) State and local courts (including juvenile courts), or units of local government that—
...
(E) certify that,[2](#3796hh_2_target) their laws, policies, or practices will ensure that—
...
[1 So in original. Probably should be followed by a comma.](#3796hh_1)

[2 So in original. The comma probably should not appear.](#3796hh_2)