...
(1) provide law enforcement officer training regarding mental health and working with individuals with mental illnesses, with an emphasis on de-escalation of encounters between law enforcement officers and those with mental disorders or in crisis, which shall include support [1](#3797aa-1_1_target) the development of in-person and technical information exchanges between systems and the individuals working in those systems in support of the concepts identified in the training;
