...
(4) to support studies of the appropriateness of [1](#10705_1_target) efficacy of court organization and financing structures in particular States, and to enable States to implement plans for improved court organization and finance;
...
(14) conduct [2](#10705_2_target) not more than 5 projects at an aggregate cost of not to exceed $600,000—
...
[1 So in original. Probably should be "and".](#10705_1)

[2 So in original. Probably should be "to conduct".](#10705_2)