...
(5) [1](#10138_1_target) An affected Indian tribe may not receive any grant under paragraph (1) after the expiration of the 1-year period following—
...
(iii) the date on which the Commission disapproves an application for a construction authorization for a repository at such site; [2](#10138_2_target)
...
[1 So in original. Probably should be designated "(5)(A)".](#10138_1)

[2 So in original. Probably should be followed by "or".](#10138_2)