...
(C) is engaged in a work activity (as such term is defined in section 407(d) of the Social Security Act (42 U.S.C. 607(d)), as in effect on and after July 1, 1997)); [1](#1437j_1_target)
...
(II) that the determination of noncompliance is subject to the administrative grievance procedure under subsection (k); [2](#1437j_2_target) and
...
[1 So in original. Probably should be only one closing parenthesis.](#1437j_1)

[2 See References in Text note below.](#1437j_2)