...
(i) that [1](#1437c-1_1_target) the information is available as required under subparagraph (A); and

(ii) that [1](#1437c-1_1_target) a public hearing under paragraph (1) will be conducted.
...
[1 So in original. The word "that" probably should not appear.](#1437c-1_1)