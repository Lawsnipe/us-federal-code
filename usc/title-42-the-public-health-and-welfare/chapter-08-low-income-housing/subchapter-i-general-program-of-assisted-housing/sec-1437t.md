...
A public housing agency may convert a public housing project (or portion thereof) owned by the agency to tenant-based assistance only pursuant to a conversion assessment under subsection (b) of this section that one year [1](#1437t_1_target) and that demonstrates that the conversion—
