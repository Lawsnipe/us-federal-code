...
(iii) the information described in subparagraph (B) with respect to each notification with respect to which such a determination was so made.[1](#300gg-112_1_target)
...
[1 So in original. The period probably should be a semicolon.](#300gg-112_1)