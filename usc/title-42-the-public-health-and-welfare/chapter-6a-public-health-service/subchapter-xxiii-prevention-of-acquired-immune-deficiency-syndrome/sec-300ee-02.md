...
(B) information that can assist emergency response employees in distinguishing between conditions in which such employees are at risk with respect to such etiologic agent and conditions in which such employees are not at risk with respect [1](#300ee-2_1_target) such etiologic agent.
...
[1 So in original. Probably should be "respect to".](#300ee-2_1)