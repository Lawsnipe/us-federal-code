...
In determining the amount of non-Federal contributions that an eligible entity has provided pursuant to subparagraph (A),[2](#300jj-34_2_target) the National Coordinator may not include any amounts provided to the entity by the Federal Government.
...
[1 So in original. The word "and" probably should appear at end of subpar. (D).](#300jj-34_1)

[2 So in original. Probably means "paragraph (1),".](#300jj-34_2)