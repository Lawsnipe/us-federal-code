...
A State or local juvenile justice agency receiving a grant under subsection (a) shall use the amounts provided under the grant—
...
A State or local juvenile justice agency that desires a grant under subsection (a) shall submit an application to the Secretary at such time, in such manner, and accompanied by such information as the Secretary may reasonably require.
