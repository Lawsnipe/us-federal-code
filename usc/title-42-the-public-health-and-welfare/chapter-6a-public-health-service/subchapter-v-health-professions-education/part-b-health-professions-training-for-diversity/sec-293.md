...
The requirements of paragraph (1)(C) shall not apply to a historically black college or university that receives funding under paragraphs [1](#293_1_target) (2) or (5).
...
(ii) and [2](#293_2_target) available after grants are made with funds under clause (i), the Secretary shall make available—
...
(2) and [2](#293_2_target) such sums as are necessary for each subsequent fiscal year.
...
[1 So in original. Probably should be "paragraph".](#293_1)

[2 So in original. The word "and" probably should not appear.](#293_2)