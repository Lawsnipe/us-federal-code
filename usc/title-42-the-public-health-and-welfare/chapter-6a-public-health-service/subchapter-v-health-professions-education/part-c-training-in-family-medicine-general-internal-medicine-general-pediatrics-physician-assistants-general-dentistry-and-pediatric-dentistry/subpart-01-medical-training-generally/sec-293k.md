...
(A) proposes [1](#293k_1_target) a collaborative project between academic administrative units of primary care;

(B) proposes [1](#293k_1_target) innovative approaches to clinical teaching using models of primary care, such as the patient centered medical home, team management of chronic disease, and interprofessional integrated models of health care that incorporate transitions in health care settings and integration physical and mental health provision;
