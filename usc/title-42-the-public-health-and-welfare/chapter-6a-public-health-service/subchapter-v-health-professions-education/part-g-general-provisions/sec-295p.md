...
(A) has as its objective the education of individuals who, upon completion of their studies in the program, be [1](#295p_1_target) qualified to provide primary care medical services with the supervision of a physician; and
...
(B) is eligible to be served by a migrant health center under section 254b [2](#295p_2_target) of this title, a community health center under section 254c [2](#295p_2_target) of this title, a grantee under section 254b(h) of this title (relating to homeless individuals), or a grantee under section 256a [2](#295p_2_target) of this title (relating to residents of public housing);
...
[1 So in original. Probably should be "will be".](#295p_1)

[2 See References in Text notes below.](#295p_2)

[3 So in original. The word "a" probably should appear.](#295p_3)

[4 So in original. The word "and" probably should appear.](#295p_4)