...
Until such time as the State develops a process to assure the proper training and certification of facility personnel in the skills and competencies referred [1](#290jj_1_target) in paragraph (1)(B), the facility involved shall develop and implement an interim procedure that meets the requirements of subparagraph (B).
