...
In response to an [3](#17935_3_target) request from an individual for an accounting, a covered entity shall elect to provide either an—
...
The Secretary may set an effective date that is later that [4](#17935_4_target) the date specified under subparagraph (A) or (B) if the Secretary determines that such later date is necessary, but in no case may the date specified under—
...
(Pub. L. 111–5, div. A, title XIII, §13405, Feb. 17, 2009, 123 Stat. 264.)
...
[3 So in original. Probably should be "a".](#17935_3)

[4 So in original. Probably should be "than".](#17935_4)