...
(2) If the Senate is not in session on the day on which such an agreement is submitted, the implementing bill shall be introduced in the Senate, as provided in the [1](#6249c_1_target) paragraph (1), on the first day thereafter on which the Senate is in session.
...
[1 So in original. The word "the" probably should not appear.](#6249c_1)