...
Subsecs. (d) to (f). Pub. L. 108–173, §911(c)(5), struck out subsecs. (d) to (f), which provided that contracts under this section could require surety bonds and that certifying or disbursing officers or carriers would not be liable with respect to payments in the absence of gross negligence or intent to defraud and defined "carrier" for purposes of this part.
