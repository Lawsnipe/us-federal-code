...
(VII) for a subsequent fiscal year (before the first fiscal year in which the payment revisions described in paragraph (6)(D) are implemented), subject to clause (iv),,[1](#1395f_1_target) the market basket percentage increase for the fiscal year.
...
(C) the specification of EHR reporting periods under section 1395ww(n)(6)(B) [3](#1395f_3_target) of this title as applied under paragraphs (3) and (4); and
...
[3 So in original. Probably should be “1395ww(n)(3)(B)”.](#1395f_3)