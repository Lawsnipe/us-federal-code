...
If more than one of the events specified in subsections (c) and (d) of this section and section 422(b) [1](#403_1_target) of this title occurs in any one month which would occasion deductions equal to a benefit for such month, only an amount equal to such benefit shall be deducted.
