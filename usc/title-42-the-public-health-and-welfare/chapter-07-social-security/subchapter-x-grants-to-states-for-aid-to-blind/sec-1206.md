...
(2) making such payments only in cases in which such payments will, under the rules otherwise applicable under the State plan for determining need and the amount of aid to the blind to be paid (and in conjunction with other income and resources), meet all the need [1](#1206_1_target) of the individuals with respect to whom such payments are made;
...
[1 So in original. Probably should be "needs".](#1206_1)