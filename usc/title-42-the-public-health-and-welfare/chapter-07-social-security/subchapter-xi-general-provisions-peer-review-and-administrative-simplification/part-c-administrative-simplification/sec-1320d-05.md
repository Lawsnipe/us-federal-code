...
(i) if the violation is corrected as described in subsection (b)(3)(A),[1](#1320d-5_1_target) a penalty in an amount that is at least the amount described in paragraph (3)(C) but not to exceed the amount described in paragraph (3)(D); and
...
In the case of a failure to comply which is due to reasonable cause and not to willful neglect, any penalty under subsection (a) and any damages under subsection (d) that is [2](#1320d-5_2_target) not entirely waived under paragraph (3) [3](#1320d-5_3_target) may be waived to the extent that the payment of such penalty [4](#1320d-5_4_target) would be excessive relative to the compliance failure involved.
...
[1 So in original. Probably should be "(b)(2)(A),".](#1320d-5_1)

[2 So in original. Probably should be "are".](#1320d-5_2)

[3 So in original. Probably should be "(2)".](#1320d-5_3)

[4 So in original. The words "or damages" probably should appear after "penalty".](#1320d-5_4)