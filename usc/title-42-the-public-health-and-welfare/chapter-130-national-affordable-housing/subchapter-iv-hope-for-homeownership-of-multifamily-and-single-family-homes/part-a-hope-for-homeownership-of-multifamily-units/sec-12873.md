...
(6) Development of resident management corporations and resident management councils, but only if the applicant has not received assistance under section 12872 [1](#12873_1_target) of this title for such activities.
...
#### (d) [2](#12873_2_target) Application
...
(D) a description of the proposed homeownership program, consistent with section 12874 [1](#12873_1_target) of this title and the other requirements of this part, specifying the activities proposed to be carried out and their estimated costs, identifying reasonable schedules for carrying it out, and demonstrating the program will comply with the affordability requirements under section 12874(b) [1](#12873_1_target) of this title;
...
#### (d) [2](#12873_2_target) Selection criteria
...
(6) the extent to which a sufficient supply of affordable rental housing of the type assisted under this title [1](#12873_1_target) exists in the locality, so that the implementation of the homeownership program will not appreciably reduce the number of such rental units available to residents currently residing in such units or eligible for residency in such units; and

(7) such other factors as the Secretary determines to be appropriate for purposes of carrying out the program established by the [3](#12873_3_target) part in an effective and efficient manner.
...
[1 See References in Text note below.](#12873_1)

[2 So in original. Two subsecs. (d) have been enacted.](#12873_2)

[3 So in original. Probably should be "this".](#12873_3)