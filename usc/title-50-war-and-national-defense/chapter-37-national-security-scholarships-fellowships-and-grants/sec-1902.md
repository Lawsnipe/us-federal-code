...
(C) [1](#1902_1_target) Subject to subparagraph (D), the obligation to reimburse the United States under an agreement under subparagraph (A) is for all purposes a debt owing the United States.
...
[1 So in original. No subpar. (B) has been enacted.](#1902_1)