...
(D) the number of customer selectors targeted under orders or directives received, combined, under this chapter for contents [1](#1874_1_target) reported in bands of 1000 starting with 0–999;
...
(3) A semiannual report that aggregates the number of orders, directives, or national security letters with which the person was required to comply in the [2](#1874_2_target) into separate categories of—
...
[1 So in original. Probably should be followed by a comma.](#1874_1)

[2 So in original.](#1874_2)