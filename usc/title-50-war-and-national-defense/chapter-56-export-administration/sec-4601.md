...
(10) It is important that the administration of export controls imposed for foreign policy purposes give [1](#4601_1_target) special emphasis to the need to control exports of goods and substances hazardous to the public health and the environment which are banned or severely restricted for use in the United States, and which, if exported, could affect the international reputation of the United States as a responsible trading partner.
...
[1 So in original. Probably should be "gives".](#4601_1)