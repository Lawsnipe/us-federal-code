...
(B) "socially and economically disadvantaged individuals" shall be presumed to include these [1](#3718_1_target) groups and individuals described in the last paragraph of section 8(d)(3)(C) of the Small Business Act; and
...
(B) a provision stating that the head of the executive or [2](#3718_2_target) legislative agency which refers a claim under the contract retains the authority to resolve a dispute regarding the claim, to compromise the claim, or to terminate a collection action on the claim; and

(C) a provision requiring the private counsel to transmit monthly to the Attorney General and the head of the executive or [1](#3718_1_target) legislative agency referring a claim under the contract a report on the services relating to the claim rendered under the contract during the month and the progress made during the month in collecting the claim under the contract.
...
[1 So in original. Probably should be "the".](#3718_1)

[2 So in original. Probably should be ", judicial, or".](#3718_2)