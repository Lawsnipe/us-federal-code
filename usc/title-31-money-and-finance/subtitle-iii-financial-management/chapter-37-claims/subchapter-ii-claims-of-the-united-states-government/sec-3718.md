...
(C) a provision requiring the private counsel to transmit monthly to the Attorney General and the head of the executive or [2](#3718_2_target) legislative agency referring a claim under the contract a report on the services relating to the claim rendered under the contract during the month and the progress made during the month in collecting the claim under the contract.
