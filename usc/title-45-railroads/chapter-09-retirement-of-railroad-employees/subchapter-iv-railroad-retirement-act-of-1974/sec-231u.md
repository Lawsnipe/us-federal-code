...
(A) the first fiscal year during which benefits under this subchapter must be reduced, in the absence of any adjustments, because insufficient funds (including any general revenue borrowing authority under this subchapter) would preclude payment of full benefits (other than benfits [1](#231u_1_target) payable from the Dual Benefits Payments Account) for every month in such fiscal year;
