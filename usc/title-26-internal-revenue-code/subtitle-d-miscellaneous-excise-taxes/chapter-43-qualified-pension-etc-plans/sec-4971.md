...
In the case of a multiemployer plan which is in reorganization under section 418,[2](#4971_2_target) the same notice and opportunity shall be provided to the Pension Benefit Guaranty Corporation.
...
(B) the amount of such shortfall which is paid by the required installment under section 430(j) or 433(f), whichever is applicable [1](#4971_1_target) for such quarter (but only if such installment is paid on or before the due date for such installment).
...
For purposes of clause (i), the term "plan sponsor" has the meaning given such term by section 432(i)(9).[2](#4971_2_target)
...
[1 So in original. Probably should be followed by a comma.](#4971_1)

[2 See References in Text note below.](#4971_2)