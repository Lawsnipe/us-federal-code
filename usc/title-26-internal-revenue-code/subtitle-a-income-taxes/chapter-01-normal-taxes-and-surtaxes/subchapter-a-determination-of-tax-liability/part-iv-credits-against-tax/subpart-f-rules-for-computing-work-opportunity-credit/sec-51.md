...
The amount of wages which would (but for this subparagraph) be qualified wages under this section for an employer with respect to an individual for a taxable year shall be reduced by an amount equal to the amount of the payments made to such employer (however utilized by such employer) with respect to such individual for such taxable year under a program established under section 482(e) [1](#51_1_target) of the Social Security Act.
...
The term "wages" shall not include any amount paid or incurred to an individual who begins work for the employer after December 31, 2014 [2](#51_2_target)
