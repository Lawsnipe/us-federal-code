...
An area in an Indian reservation shall be treated as nominated by a State and a local government if it is nominated by the reservation governing body (as determined by the Secretary of [1](#1391_1_target) Interior).
...
[1 So in original. Probably should be followed by "the".](#1391_1)