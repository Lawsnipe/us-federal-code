...
The plan sponsor of a plan in critical status, as described in subsection [1](#418E_1_target) 432(b)(2),hall determine in writing for each insolvency year the resource benefit level and the level of basic benefits no later than 3 months before the insolvency year.
