...
All employers that are treated as a single employer under subsection (b) or (c) shall be treated as a single employer for purposes of determining if a plan was maintained by more than one employer under subparagraph [6](#414_6_target) (B) and (C) of paragraph (1).
