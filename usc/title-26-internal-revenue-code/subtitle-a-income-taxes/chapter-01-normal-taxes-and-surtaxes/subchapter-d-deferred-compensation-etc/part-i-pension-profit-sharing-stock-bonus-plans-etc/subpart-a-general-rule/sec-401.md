...
(II) no individual (other than a [1](#401_1_target) eligible designated beneficiary described in subclause (III) or (IV) of subparagraph (E)(ii)) has any right to the employee's interest in the plan until the death of all such eligible designated beneficiaries with respect to the trust,
