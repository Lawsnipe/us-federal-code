...
#### (d) Special rules for overpayments
...
#### (f) [1](#7508A_1_target) Significant fire
...
#### (f) [1](#7508A_1_target) Application to limitation on credit or refund
...
[1 So in original. There are two subsecs. (f).](#7508A_1)