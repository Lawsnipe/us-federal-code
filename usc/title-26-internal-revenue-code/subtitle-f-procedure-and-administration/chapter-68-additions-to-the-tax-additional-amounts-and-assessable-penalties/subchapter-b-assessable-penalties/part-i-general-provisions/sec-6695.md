...
If any amount adjusted under subparagraph (A)— [1](#6695_1_target)
...
(B) is not described in clause (i) [2](#6695_2_target) and is not a multiple of $5, such amount shall be rounded to the next lowest multiple of $5.
...
[1 So in original. Probably should be "paragraph (1)—".](#6695_1)

[2 So in original. Probably should be "subparagraph (A)".](#6695_2)