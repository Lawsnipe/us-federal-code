...
In the case of a joint return, any disclosure authorized under subparagraph (A), (B), or (C), and any redisclosure authorized under clause (iii), (iv) [2](#6103_2_target) (v), or (vi) of subparagraph (D), with respect to an individual shall be treated for purposes of this paragraph as applying with respect to the taxpayer.
...
[2 So in original. Probably should be followed by a comma.](#6103_2)

[3 So in original.](#6103_3)