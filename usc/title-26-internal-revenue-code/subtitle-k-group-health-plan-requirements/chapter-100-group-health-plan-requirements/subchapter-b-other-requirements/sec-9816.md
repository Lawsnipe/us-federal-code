...
(iv) such items and services were furnished during the 30 day [2](#9816_2_target) period following the date on which the first item or service included with respect to such determination was furnished or an alternative period as determined by the Secretary, for use in limited situations, such as by the consent of the parties or in the case of low-volume items and services, to encourage procedural efficiency and minimize health plan and provider administrative costs.
...
Each party to a determination under paragraph (5) to which an entity is selected under paragraph (3) [3](#9816_3_target) in a year shall pay to the Secretary, at such time and in such manner as specified by the Secretary, a fee for participating in the IDR process with respect to such determination in an amount described in subparagraph (B) for such year.
...
[2 So in original. Probably should be "30-day".](#9816_2)

[3 So in original. Probably should be "paragraph (4)".](#9816_3)