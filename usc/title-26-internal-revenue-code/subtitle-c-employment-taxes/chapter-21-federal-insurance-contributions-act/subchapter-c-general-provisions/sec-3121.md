...
(V) if an individual performing service described in subparagraph (A) returns to the performance of such service after employment (by a tribal organization) to which section 105(e)(2) [1](#3121_1_target) of the Indian Self-Determination Act applies, then the service performed for that tribal organization shall be considered service described in subparagraph (A); or
...
[1 See References in Text note below.](#3121_1)

[2 So in original. Probably should be followed by a comma.](#3121_2)