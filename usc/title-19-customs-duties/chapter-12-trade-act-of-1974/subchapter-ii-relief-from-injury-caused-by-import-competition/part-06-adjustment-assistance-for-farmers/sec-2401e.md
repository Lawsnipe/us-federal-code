...
To comply with the limitation under subparagraph (A),[2](#2401e_2_target) an individual or entity shall provide to the Secretary—
...
The total amount of payments made to an agricultural producer under this part during any crop year may not exceed the limitation on counter-cyclical payments set forth in section 1308(c) [3](#2401e_3_target) of title 7.
...
[1 So in original. Probably should be "an".](#2401e_1)

[2 So in original. Probably should be a reference to clause (i).](#2401e_2)

[3 See References in Text note below.](#2401e_3)