...
In this paragraph, the term "unresolved audit finding" means an audit report finding in the final audit report of the Inspector General of the Department of Justice that the grantee has used grant funds for an unauthorized expenditure or otherwise unallowable cost that is not closed or resolved during the 12-month period beginning on the date on which the final audit report is issued [1](#7113_1_target)
...
(Pub. L. 113–4, title XII, §1236, Mar. 7, 2013, 127 Stat. 147.)
...
[1 So in original. Probably should be followed by a period.](#7113_1)