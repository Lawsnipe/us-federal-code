...
Subsection (a) also applies with respect to an individual convicted of a Federal drug offense, or a State drug offense, if the offense is [1](#2714_1_target) misdemeanor, but only if the Secretary of State determines that subsection (a) should apply with respect to that individual on account of that offense. This paragraph does not apply to an individual's first conviction for a misdemeanor which involves only possession of a controlled substance.
