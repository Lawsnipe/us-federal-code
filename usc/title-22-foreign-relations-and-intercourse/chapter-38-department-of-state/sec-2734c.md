...
Upon full implementation of a right and process for employees to appeal an assignment restriction or preclusion under subsection (a), the Secretary shall submit to the appropriate congressional committee [1](#2734c_1_target) a report that—
...
[1 So in original. Probably should be "committees".](#2734c_1)