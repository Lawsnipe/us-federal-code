...
(3) Act in a manner fully consistent with the Guidelines for Nuclear Transfers and the Guidelines for Transfers of Nuclear-Related Dual-Use Equipment, Materials, Software and Related Technology developed by the NSG, and decisions related to the those [1](#8002_1_target) guidelines, and the rules and practices regarding NSG decisionmaking.
